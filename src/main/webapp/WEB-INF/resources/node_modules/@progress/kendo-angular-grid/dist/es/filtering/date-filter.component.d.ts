 ...
 * @hidden
 */
export declare class DateFilterComponent extends BaseFilterCellComponent implements FilterComponent {
    ...
    /**
     * Specifies the hint the component displays when its value is `null`.
     */
    placeholder: string;
    /**
